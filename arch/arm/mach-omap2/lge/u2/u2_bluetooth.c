...
#define BT_RESET_GPIO GPIO_BT_RESET

#define BT_WAKE_GPIO GPIO_BT_WAKE
#define BT_HOST_WAKE_GPIO GPIO_BT_HOST_WAKE
...
static int bcm4330_bluetooth_probe(struct platform_device *pdev)
{
	...
	rc = gpio_request(BT_RESET_GPIO, "bcm4330_nreset_gpio");
	if (unlikely(rc)) {
		return rc;
	}
